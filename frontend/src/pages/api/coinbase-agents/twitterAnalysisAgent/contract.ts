...
const CONTRACT_ADDRESS = "0x930C594144D4b20471FCe94b2ba69336492Fd4e3";
const TOKEN_ADDRESS = "0xf879432b14B4635fC1aDEfa0C0555B9db60936C6";

// CONTRACTS
const networkState = new web3.eth.Contract(
  NETWORK_STATE_ABI,
  "0x930C594144D4b20471FCe94b2ba69336492Fd4e3",
);
const token = new web3.eth.Contract(
  TOKEN_ABI,
  "0xf879432b14B4635fC1aDEfa0C0555B9db60936C6",
);
